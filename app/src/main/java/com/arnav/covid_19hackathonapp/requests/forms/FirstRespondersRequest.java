...
import com.arnav.covid_19hackathonapp.requests.firebase.FirstRespondersRequestData;
...
public class FirstRespondersRequest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_responders_request);

        //Hooks
        addressreq = findViewById(R.id.street_address_first);
        suitereq = findViewById(R.id.suite_first);
        statereq = findViewById(R.id.state_first);
        namereq = findViewById(R.id.hospital_first);
        amountreq = findViewById(R.id.amount_first);
        commentsreq = findViewById(R.id.comments_first);
        submitreq = findViewById(R.id.submit_first);
        cityreq = findViewById(R.id.city_first);
        phonereq = findViewById(R.id.phone_first);
        whatreq = findViewById(R.id.what_first);
        ...
        submitreq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final FirstRespondersRequestData firstData = new FirstRespondersRequestData(address, suite, city, state, hospital, amount, comments, what);
                //add data
                authref.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            reference.child(phoneNumberFromDB).setValue(firstData);
